  ...
  saveLead: async (lead: Lead): Promise<Lead> => {
    ...
    if (existingData) {
      ...
      const params = [
        ...
        lead.email !== undefined ? (lead.email === "" ? null : lead.email) : existingData.email,
        lead.telefone !== undefined ? (lead.telefone === "" ? null : lead.telefone) : existingData.telefone,
        lead.celular !== undefined ? (lead.celular === "" ? null : lead.celular) : existingData.celular,
        lead.empresa !== undefined ? (lead.empresa === "" ? null : lead.empresa) : existingData.empresa,
        ...
        consent,
        newObs,
        lead.utm_source !== undefined ? lead.utm_source : existingData.utm_source,
        lead.utm_medium !== undefined ? lead.utm_medium : existingData.utm_medium,
        lead.utm_campaign !== undefined ? lead.utm_campaign : existingData.utm_campaign,
        lead.cidade !== undefined ? (lead.cidade === "" ? null : lead.cidade) : existingData.cidade,
        lead.estado !== undefined ? (lead.estado === "" ? null : lead.estado) : existingData.estado,
        totalConversoes,
        ...
        isMeta,
        lead.documento !== undefined ? (lead.documento === "" ? null : lead.documento) : (existingData.documento || null),
