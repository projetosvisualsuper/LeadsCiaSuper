      ...
      <div style={{ 
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            O aplicativo <strong>Leads Cia Super</strong> (operado no domínio <strong>leads.ciasuper.com.br</strong>) está totalmente comprometido com a segurança e a proteção da privacidade dos seus usuários.
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <ul style={{ listStyleType: 'disc', paddingLeft: '1.75rem', marginBottom: '1rem', display: 'grid', gap: '0.5rem' }}>
            ...
            <li>Envio de respostas a comentários de forma automatizada ou manual a partir do painel administrativo do site <strong>leads.ciasuper.com.br</strong>.</li>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Os tokens de autenticação concedidos pelo usuário e os dados coletados são salvos em nosso banco de dados utilizando criptografia e práticas rígidas de segurança da informação no ambiente do servidor de <strong>leads.ciasuper.com.br</strong>.
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <ul style={{ listStyleType: 'disc', paddingLeft: '1.75rem', marginBottom: '1rem', display: 'grid', gap: '0.5rem' }}>
            ...
            <li>Desconectar a conta no menu "Integrações" do painel de <strong>leads.ciasuper.com.br</strong>, o que remove imediatamente todos os tokens de acesso de nossos servidores.</li>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Reservamos o direito de atualizar esta Política de Privacidade conforme necessário para refletir alterações no sistema ou nos requisitos regulamentares. Recomendamos que você a revise periodicamente no endereço <strong>leads.ciasuper.com.br/privacy</strong>.
          </p>
        </section>
