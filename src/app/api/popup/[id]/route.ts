        ...
        contentContainer.innerHTML = \`
          ...
          <div style="text-align: center; padding: 2.5rem 2rem; background: white; color: #1e293b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; box-sizing: border-box; width: 100%;">
            ...
            <div style="display: grid; gap: 0.75rem; width: 100%;">
              ...
              \${popupData.buttonLink ? \`<a href="\${popupData.buttonLink}" style="display:flex; align-items:center; justify-content:center; width:100%; height:58px; border-radius:12px; background:\${theme.buttonColor || '#fbbf24'}; color:\${theme.buttonTextColor || '#1e293b'}; font-weight:800; text-align:center; text-decoration:none; font-size:1.15rem; box-sizing:border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">\${popupData.buttonText || 'OK, Continuar'}</a>\` : ''}
            </div>
            \${sendEmail ? \`
